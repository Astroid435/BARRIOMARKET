...
class MyUserCreationForm(forms.ModelForm):
    Correo = forms.EmailField(
        widget=forms.EmailInput(attrs={
            'class': 'form-control', 'placeholder': 'Ej: name@example.com'
        }),
        error_messages={
    ...
    password1 = forms.CharField(
        ...
        widget=forms.PasswordInput(attrs={
            'class': 'form-control col-6', 'placeholder': 'Contraseña'
        }),
    ...
    password2 = forms.CharField(
        ...
        widget=forms.PasswordInput(attrs={
            'class': 'form-control col-6', 'placeholder': 'Confirmar contraseña'
        }),
        error_messages={'required': 'Debe confirmar la contraseña'}
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            'Documento', 'Telefono', 'password1', 'password2'
        ]
        help_texts = {k: "" for k in fields}
        widgets = {
            'Primer_nombre': forms.TextInput(attrs={
                'class': 'form-control col-6', 'placeholder': 'Primer Nombre'
            }),
            'Primer_apellido': forms.TextInput(attrs={
                'class': 'form-control col-6', 'placeholder': 'Primer Apellido'
            }),
